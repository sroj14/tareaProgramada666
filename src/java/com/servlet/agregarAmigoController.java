 ...
 */
@WebServlet(name = "agregarAmigoController", urlPatterns = {"/agregarAmigoController"})
public class agregarAmigoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Nodo amigo = l.obtenerAmigo();
            Nodo usuario = l.obtenerUsuario();
            if (amigo != null && usuario != null) {
                datos.establecerRelacion(usuario, amigo);
                dato.guardarDato(datos);
