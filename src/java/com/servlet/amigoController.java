...
public class amigoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ListaEnlazada l = dato.obtenerListaNodos();
            Nodo amigo = l.encontrarPorNombre(request.getParameter("persona"));
            if (amigo != null) {
                datos.guardarDato(dato);
            ...
            Logger.getLogger(amigoController.class.getName()).log(Level.SEVERE, null, ex);
        }
